...
physically connected. This is an optional field.
...
replaced, ensuring reliable system recovery.
    ...
    "<EEPROM_PATH_OF_FRU>": [
      {
        ...
        "extraInterfaces":"<It is used to define additional D-Bus interfaces
         and properties to be hosted by the FRU's inventory object>"
        {
          "LocationCode": "<string: Unique physical location code>",
          "PrettyName": "<string: User-friendly FRU name>",
          "SlotType": "<string, PCIe Slot type where FRU is installed>",
          "SlotNumber": "<Integer,The physical index or identification number
           of the PCIe slot where the FRU is installed>"
        },
        "preAction": "<string: Please refer below for the detailed explanation>",
        "postAction": "<string: Please refer below for the detailed explanation>",
        "postFailAction": "<string: Please refer below for the detailed explanation>",
        ...
        "powerOffOnly": "<bool: VPD can be collected only when chassis power is OFF>",
