...
hardware layout of the platform, including buses,devices, and how components
are physically connected.

## backupRestoreConfigPath

Defines the file path used by the system to back up and restore the system
JSON configuration.This ensures FRU configuration can be restored during
system recovery or firmware updates.

## commonInterfaces

Specifies the standard DBus interfaces and properties that apply to all FRUs
in the system. This section defines shared attributes under
...
Commands that need to be filled for the postAction _deletion_ step.
...
to safely restore hardware to a known state.There are two types of postFailAction
...
array of field names,allowing the child FRU to copy/inherit
