...
backup is used to restore system VPD data if the BMC or motherboard is replaced,
ensuring reliable system recovery. Please note that if both are replaced
bakcup&restore cannot happen.
