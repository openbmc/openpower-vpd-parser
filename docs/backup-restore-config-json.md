...
used for backing up and restoring system VPD (Vital Product Data). It explains
required fields, value formats, and provides guidance for extending VPD handling
for system use.
...
Specifies the location of the primary system VPD. This section is mandatory for
