...
hardware. The file path is determined by prepending `/var/lib/vpd/file` to the
System VPD EEPROM path entry in the system configuration JSON.
...
prepending `/var/lib/vpd/file` to the System VPD EEPROM path entry in the system
configuration JSON.
