...
inline bool compareVpdMaps(
    const types::VPDMapVariant& i_primaryParsedVpd,
    const types::VPDMapVariant& i_redundantParsedVpd,
    types::MismatchedVpdVariant& o_mismatchedVpd, std::string& o_missingRecords,
    std::string& o_missingKeywords, uint16_t& o_errCode) noexcept
{
    bool l_rc{true};
