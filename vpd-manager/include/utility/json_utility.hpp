 ...
 */
inline bool handleGpioPresenceTag(bool l_tagPrecessingRes,
                                  ...
                                  types::BaseActionResult& io_result)
{
    ...
    if (!l_tagPrecessingRes)
    {
        if (i_tagErrorCode == error_code::DEVICE_NOT_PRESENT)
        {
            ...
            io_result.presenceStatus =
                types::BaseActionResult::PresenceStatus::ABSENT;
            return false;
        }
        else
        {
            ...
            io_result.presenceStatus =
                types::BaseActionResult::PresenceStatus::UNKNOWN;
    ...
    else
    {
        ...
        io_result.presenceStatus =
            types::BaseActionResult::PresenceStatus::PRESENT;
    }
...
/**
 * @brief Process any action with enhanced error reporting and presence
 * detection.
 *
    ...
    uint16_t& o_errCode)
{
    ...
    for (const auto& l_tag : l_tagsJson.items())
    {
        ...
        else
        {
            ...
            handleNonGpioPresenceTag(l_tagName, l_tagErrorCode, i_vpdFilePath,
                                     l_actionRes);
            ...
            if (l_gpioPresenceDefined && !l_gpioPresenceProcessed)
            {
                ...
                handleGpioPresenceTag(l_gpioRes, l_gpioErrorCode, l_actionRes);
            }
        }
