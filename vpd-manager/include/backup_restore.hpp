...
class BackupAndRestore
{
  ...
  private:
    ...
    /**
     * @brief An API to check primary and backup paths are EEPROM paths.
     *
     * @return true if both primary and backup VPDs present on the EEPROM path,
     * false otherwise.
     */
    bool isPrimaryAndBackupVpdOnFru() const noexcept;
