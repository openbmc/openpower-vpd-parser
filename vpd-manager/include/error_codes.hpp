...
const std::unordered_map<int, std::string> errorCodeMap = {
    ...
    {error_code::PATH_NOT_FOUND_IN_JSON,
     "The given EEPROM/inventory path was not found in the JSON configuration."},
    ...
    {error_code::INVALID_LOCATION_CODE_FORMAT,
     "Malformed location code format found."},
    ...
    {error_code::CHECKSUM_VALIDATION_FAILED, "Checksum validation failed"},
