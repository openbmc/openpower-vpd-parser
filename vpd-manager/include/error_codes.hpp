...
const std::unordered_map<int, std::string> errorCodeMap = {
    ...
    {error_code::PRESENCE_INVALID_INPUT_PARAMETER, "Invaid input parameter detected while reading presence gpio."},
    {error_code::JSON_MISSING_PRESENCE_GPIO_INFO,"JSON missing presence gpio info."}
} // namespace vpd
