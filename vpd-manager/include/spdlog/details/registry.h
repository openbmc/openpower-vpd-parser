...
class SPDLOG_API registry
{
  public:
    ...
    // set_default_logger(). e.g do not call set_default_logger() from one
    // thread while calling spdlog::info() from another.
    ...
    // the loggers_ map. Note: Make sure to unregister it when no longer needed
    // or before calling again with a new logger.
