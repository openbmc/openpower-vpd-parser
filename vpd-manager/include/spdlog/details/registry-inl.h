...
{
#ifndef SPDLOG_DISABLE_DEFAULT_LOGGER
// create default logger (ansicolor_stdout_sink_mt or wincolor_stdout_sink_mt in
// windows).
#ifdef _WIN32
...
SPDLOG_INLINE void registry::register_or_replace(
...
// set default logger.
// the default logger is stored in default_logger_ (for faster retrieval) and in
// the loggers_ map.
...
SPDLOG_INLINE void registry::register_or_replace_(
    std::shared_ptr<logger> new_logger)
{
