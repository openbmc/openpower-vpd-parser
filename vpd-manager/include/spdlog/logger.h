...
#define SPDLOG_LOGGER_CATCH(location)                                          \
    ...
    {                                                                          \
        ...
        {                                                                      \
            err_handler_(                                                      \
                fmt_lib::format(SPDLOG_FMT_STRING("{} [{}({})]"), ex.what(),   \
...
class SPDLOG_API logger
{
  public:
             ...
             level::level_enum lvl, wstring_view_t msg)
    {
        ...
        memory_buf_t buf;
        details::os::wstr_to_utf8buf(wstring_view_t(msg.data(), msg.size()),
                                     buf);
    ...
    // Note: each sink will get a new instance of a formatter object, replacing
    // the old one.
