...
class basic_printf_context
{
  ...
  public:
    ...
    /// stored in the context object so make sure they have appropriate
    /// lifetimes.
  ...
  public:
    ...
    void operator()(const char* value)
    {
        if (value)
            ...
            write_null_pointer(
                this->specs.type() != presentation_type::pointer);
    }
             ...
             basic_format_args<Context> args)
{
    ...
    // Returns the argument with specified index or, if arg_index is -1, the
    // next argument.
    ...
    while (it != end)
    {
        ...
        if (it != end && *it == '.')
        {
            ...
            else if (c == '*')
            {
                ...
                specs.precision = static_cast<int>(
                    get_arg(-1).visit(printf_precision_handler()));
            }
            else
            {
                specs.precision = 0;
        ...
        if (specs.fill_unit<Char>() == '0')
        {
            ...
            {
                // Ignore '0' flag for non-numeric types or if '-' flag is also
                // present.
                specs.set_fill(' ');
            }
        }
