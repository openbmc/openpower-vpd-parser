...
SPDLOG_API void set_pattern(std::string pattern, pattern_time_type time_type =
...
//
// The default logger can be replaced using
// spdlog::set_default_logger(new_logger). For example, to replace it with a
// file logger.
//
// IMPORTANT:
