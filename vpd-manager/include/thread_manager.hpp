...
class ThreadManager
{
  ...
  private:
    ...
    // Chassis VPD collection result, who's action based on the result is
    // pending
    std::queue<std::tuple<bool, std::string, nlohmann::json>> m_chassisTasks;
     ...
     *
     * Processing continues until all chassis and associated FRUs complete
     * VPD collection.
     *
     */
