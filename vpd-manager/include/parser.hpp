...
class Parser
{
  ...
  private:
     ...
     * in the common interface(s) corresponding to the record and keyword which
     * needs to be updated and updates the property.
     *
     * @param[in] i_objPath - Object path of FRU
     * @param[in] i_paramsToWriteData - Input details
     *
