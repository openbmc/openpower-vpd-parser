...
/* Enum for representing different areas in IPMI FRU VPD format*/
enum class IpmiVpdAreaIndex : uint8_t
{
    ...
    PRODUCT_INFO_AREA,
    MULTI_RECORD_AREA,
    SIZE    // total number of areas. This should always be the last entry in the enum
};
...
/* Map for holding IPMI VPD data by area. For example for Manufacturer Name in 
Product Info Area, the map entry will be of format <Product Info Area, <MNAME, IBM>> */
