...
class Listener
{
  ...
  private:
     ...
     * parses correlated properties JSON file and returns a list of correlated
     * object path, interface and property/properties.
     *
     ...
     * and property/properties. Otherwise returns an empty vector.
     */
