...
static constexpr auto VALUE_12 = 12;
...
constexpr auto rainierPlanarInvPath =
...
// Timeout (in seconds) for the VPD collection wait loop.
static constexpr uint32_t VPD_COLLECTION_TIMEOUT_SEC = 1800; // 30 minutes
...
//@todo: use PDI generated header once PhysicalContext interface gets merged
// upstream
