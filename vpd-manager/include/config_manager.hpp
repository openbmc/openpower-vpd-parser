  ...
  public:
    ...
    class ConstructorKey
    {
      private:
        ...
        /* deleted methods */
        ConstructorKey(const ConstructorKey&) = delete;
        ConstructorKey(const ConstructorKey&&) = delete;
        ConstructorKey operator=(const ConstructorKey&) = delete;
        ConstructorKey operator=(const ConstructorKey&&) = delete;
     ...
     */
    explicit ConfigManager([[maybe_unused]] const ConstructorKey& i_key,
