...
class Worker
{
  public:
     ...
     *
     * This API returns the parsed JSON from the config file.
     * Note: This method is deprecated and will be removed in future.
     * Use Manager::getConfigManager() instead for chassis-based JSON.
     *
     * @return The parsed config JSON object.
     */
    nlohmann::json getSysCfgJsonObj() const
    {
        return m_parsedJson;
    }
