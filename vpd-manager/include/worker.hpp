...
class Worker
{
  ...
  private:
    ...
    * error codes and presence status information for use during VPD collection.
    *
    * Enables information sharing between processPreAction
    * and other Worker methods (e.g., parseVpdFile, processPostAction) without requiring
    * additional parameter passing or repeated GPIO checks.
    *
    ...
    */
    std::unordered_map<std::string, types::PreActionResult> m_fruPreActionResults;
