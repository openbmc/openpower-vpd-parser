...
class LogFileHandler
{
  ...
  public:
     ...
     * @throw std::runtime_error
     */
    virtual void logMessage(const std::string_view& i_message,
                            const LogLevel i_logLevel = LogLevel::DEFAULT) = 0;
 ...
 */
class FileLogger final : public LogFileHandler
{
    /**
     ...
     * which the file will be rotated.
     */
    FileLogger(const std::filesystem::path& i_filePath,
               const size_t i_maxEntries) :
        LogFileHandler(i_filePath, i_maxEntries)
    {}
  ...
  public:
     ...
     * @throw std::runtime_error
     */
    void logMessage(const std::string_view& i_message,
...
class AsyncFileLogger final : public LogFileHandler
{
  ...
  public:
    ...
    ~AsyncFileLogger()
    {
        ...
        std::cout << "_SR ~AsyncFileLogger" << std::endl;
    }
};
