...
class Manager
{
  public:
    ...
    /**
     * @brief Checks whether the primary and its redundant EEPROMs are
     * identical.
     *
     ...
     *
     * @return true if the given EEPROM and its redundant EEPROM are the same;
     *         false otherwise.
     */
    bool validateEeproms(const types::Path& i_fruPath) const noexcept;
