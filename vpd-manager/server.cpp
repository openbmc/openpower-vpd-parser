...
int Manager::_callback_WriteKeyword(
        sd_bus_message* msg, void* context, sd_bus_error* error)
{
    ...
    try
    {
        return sdbusplus::sdbuspp::method_callback(
                msg, o->_intf, error,
                std::function(
                    [=](sdbusplus::message::object_path&& path, std::string&& record, std::string&& keyword, std::vector<uint8_t>&& value)
                    {
                        return o->writeKeyword(
                                path, record, keyword, value);
                    }
                ));
    }
...
namespace Manager
{
static const auto _param_WriteKeyword =
        utility::tuple_to_array(message::types::type_id<
                sdbusplus::message::object_path, std::string, std::string, std::vector<uint8_t>>());
static const auto _return_WriteKeyword =
        utility::tuple_to_array(std::make_tuple('\0'));
}
}

int Manager::_callback_GetFRUsByUnexpandedLocationCode(
        sd_bus_message* msg, void* context, sd_bus_error* error)
{
    auto o = static_cast<Manager*>(context);
    ...
    try
    {
        return sdbusplus::sdbuspp::method_callback(
                ...
                std::function(
                    ...
                    {
                        return o->getFRUsByUnexpandedLocationCode(
                                locationCode, nodeNumber);
                    }
                ));
    }
    catch(sdbusplus::xyz::openbmc_project::Common::Error::InvalidArgument& e)
...
int Manager::_callback_GetFRUsByExpandedLocationCode(
        sd_bus_message* msg, void* context, sd_bus_error* error)
{
    auto o = static_cast<Manager*>(context);
    ...
    try
    {
        return sdbusplus::sdbuspp::method_callback(
                ...
                std::function(
                    ...
                    {
                        return o->getFRUsByExpandedLocationCode(
                                locationCode);
                    }
                ));
    }
...
int Manager::_callback_GetExpandedLocationCode(
        sd_bus_message* msg, void* context, sd_bus_error* error)
{
    auto o = static_cast<Manager*>(context);
    ...
    try
    {
        return sdbusplus::sdbuspp::method_callback(
                ...
                std::function(
                    [=](std::string&& locationCode, uint16_t&& nodeNumber)
                    {
                        return o->getExpandedLocationCode(
                                locationCode, nodeNumber);
                    }
                ));
    }
...
int Manager::_callback_PerformVPDRecollection(
        sd_bus_message* msg, void* context, sd_bus_error* error)
{
    auto o = static_cast<Manager*>(context);
    ...
    try
    {
        return sdbusplus::sdbuspp::method_callback(
                ...
                std::function(
                    [=]()
                    {
                        return o->performVPDRecollection(
                                );
                    }
                ));
    }
...
const vtable::vtable_t Manager::_vtable[] = {
    ...
    vtable::method("WriteKeyword",
                   details::Manager::_param_WriteKeyword
                        .data(),
                   details::Manager::_return_WriteKeyword
                        .data(),
                   _callback_WriteKeyword),

    vtable::method("GetFRUsByUnexpandedLocationCode",
                   details::Manager::_param_GetFRUsByUnexpandedLocationCode
                        .data(),
                   details::Manager::_return_GetFRUsByUnexpandedLocationCode
                        .data(),
                   _callback_GetFRUsByUnexpandedLocationCode),

    vtable::method("GetFRUsByExpandedLocationCode",
                   details::Manager::_param_GetFRUsByExpandedLocationCode
                        .data(),
                   details::Manager::_return_GetFRUsByExpandedLocationCode
                        .data(),
                   _callback_GetFRUsByExpandedLocationCode),

    vtable::method("GetExpandedLocationCode",
                   details::Manager::_param_GetExpandedLocationCode
                        .data(),
                   details::Manager::_return_GetExpandedLocationCode
                        .data(),
                   _callback_GetExpandedLocationCode),

    vtable::method("PerformVPDRecollection",
                   details::Manager::_param_PerformVPDRecollection
                        .data(),
                   details::Manager::_return_PerformVPDRecollection
                        .data(),
