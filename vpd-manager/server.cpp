...
int Manager::_callback_FixBrokenEcc(
        sd_bus_message* msg, void* context, sd_bus_error* error)
{
    try
    {
...
namespace Manager
{
static const auto _param_FixBrokenEcc =
        utility::tuple_to_array(message::types::type_id<
...
const vtable::vtable_t Manager::_vtable[] = {
    ...
    vtable::method("FixBrokenEcc",
                   details::Manager::_param_FixBrokenEcc
                        .data(),
                   details::Manager::_return_FixBrokenEcc
                        .data(),
