...
class IbmHandler
{
  public:
     ...
     * @param[in] i_commoniFace - Common interface to implement.
    ...
    IbmHandler(
        ...
        const std::shared_ptr<sdbusplus::asio::dbus_interface>& i_commoniFace,
  ...
  private:
    ...
    // Shared pointer to Dbus common interface class.
    const std::shared_ptr<sdbusplus::asio::dbus_interface>& m_commonInterface;
