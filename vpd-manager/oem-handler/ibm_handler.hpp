...
class IbmHandler
{
  ...
  private:
    ...
    /**
     * @brief API to update expanded location on DBus for a FRU.
     *
     * The API updates expanded location code for a FRU on Dbus by replacing the required keyword with their VPD value.
     */
