...
void IbmHandler::updateExpandedLocationCode()
{
    ...
    for (const auto& l_inventoryPath : l_objects)
    {
        ...
        {
            auto l_chassisString =
                vpdSpecificUtility::getChassisId(l_inventoryPath);
            ...
            // check if the chassis to which FRU belongs is present. If not skip
            // processing.
