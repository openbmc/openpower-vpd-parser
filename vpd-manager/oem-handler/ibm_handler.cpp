    ...
    types::VPDMapVariant& o_parsedSystemVpdMap)
{
    ...
    vpdSpecificUtility::setCollectionStatusProperty(
        SYSTEM_VPD_FILE_PATH, types::CollectionStatus::IN_PROGRESS,
...
void IbmHandler::performInitialSetup()
{
    ...
    try
    {
        ...
        vpdSpecificUtility::setCollectionStatusProperty(
            SYSTEM_VPD_FILE_PATH, types::CollectionStatus::COMPLETED,
            m_sysCfgJsonObj, l_errCode);
    ...
    catch (const std::exception& l_ex)
    {
        ...
        vpdSpecificUtility::setCollectionStatusProperty(
            SYSTEM_VPD_FILE_PATH, types::CollectionStatus::FAILED,
            m_sysCfgJsonObj, l_errCode);
