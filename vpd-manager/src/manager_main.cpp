...
int main(int, char**)
{
    ...
    {
        logging::logMessage("VPD-Manager service failed to start.");
        vpd::EventLogger::createAsyncPel(
            EventLogger::getErrorType(l_ex), vpd::types::SeverityType::Critical,
            __FILE__, __FUNCTION__, 0, EventLogger::getErrorMsg(l_ex.what()),
