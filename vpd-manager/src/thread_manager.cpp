...
void ThreadManager::processChassisResults() noexcept
{
     ...
     * 2. Launch chassis specific FRU VPD collection thread pool, to collect its
     * FRUs VPD if that chassis is present.
     * 3. Update chassis counter and frus counter accordingly.
     * 4. Add synchronization for overall VPD collection completion handling.
     */
}
