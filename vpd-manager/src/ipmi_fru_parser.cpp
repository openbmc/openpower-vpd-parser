...
void IpmiFruParser::validateChecksum(
    [[maybe_unused]] types::BinaryVector::const_iterator i_begin,
    [[maybe_unused]] types::BinaryVector::const_iterator i_end,
    [[maybe_unused]] uint8_t i_checkByte,
    [[maybe_unused]] const std::string& i_context) const
{
...
std::string IpmiFruParser::decode6BitAscii(
    [[maybe_unused]] types::BinaryVector::const_iterator i_data,
    [[maybe_unused]] size_t i_len) const
{
...
std::string IpmiFruParser::decodeField(
    [[maybe_unused]] uint8_t i_typelen,
    [[maybe_unused]] types::BinaryVector::const_iterator i_data,
    [[maybe_unused]] uint8_t i_langCode) const
{
...
std::optional<std::string> IpmiFruParser::readNextField(
    [[maybe_unused]] types::BinaryVector::const_iterator& io_it,
    [[maybe_unused]] types::BinaryVector::const_iterator i_areaEnd,
    [[maybe_unused]] uint8_t i_lang, [[maybe_unused]] size_t& o_offset,
    [[maybe_unused]] size_t& o_rawLen) const
{
    if (io_it >= i_areaEnd)
    {
        throw DataException(
...
void IpmiFruParser::rewriteAreaChecksum([[maybe_unused]] size_t i_areaStart,
                                        [[maybe_unused]] size_t i_areaLength)
{
    if (i_areaLength == 0)
    {
...
types::DbusVariantType IpmiFruParser::readKeywordFromHardware(
    [[maybe_unused]] const types::ReadVpdParams i_params)
{
...
int IpmiFruParser::writeKeywordOnHardware(
    [[maybe_unused]] const types::WriteVpdParams i_params)
{
