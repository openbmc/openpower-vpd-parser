    ...
    uint16_t& o_errCode) noexcept
{
    ...
    std::string l_fruCollectionStatus{constants::vpdCollectionNotStarted};
    ...
    try
    {
        if (i_fruPath.empty())
        {
            ...
            return std::make_tuple(l_presence, l_fruCollectionStatus);
        }
...
#if 0
        // This part of code is required for testing. This logic will be removed
        ...
        // This part of code will be removed from this API once the FRU presence
        // detection logic is implemented in parseAndPublish API. Currently
        // thread manager class utilizes this presence status to perfrom chassis
        // based FRU collection based on the present status of chassis.
