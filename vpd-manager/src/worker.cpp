    ...
    const std::string& i_vpdFilePath)
{
    ...
    try
    {
        ...
        vpdSpecificUtility::setCollectionStatusProperty(
            i_vpdFilePath, types::CollectionStatus::IN_PROGRESS, m_parsedJson,
            l_errCode);
        if (l_errCode)
        {
            m_logger->logMessage(
    ...
    {
        vpdSpecificUtility::setCollectionStatusProperty(
            i_vpdFilePath, types::CollectionStatus::FAILED, m_parsedJson,
            l_errCode);
        if (l_errCode)
        {
            m_logger->logMessage(
    ...
    vpdSpecificUtility::setCollectionStatusProperty(
        i_vpdFilePath, types::CollectionStatus::COMPLETED, m_parsedJson,
        l_errCode);
    if (l_errCode)
    {
        m_logger->logMessage(
    ...
    const sdbusplus::message::object_path& i_dbusObjPath)
{
    ...
    try
    {
        ...
        vpdSpecificUtility::setCollectionStatusProperty(
            l_fruPath, types::CollectionStatus::IN_PROGRESS, m_parsedJson,
            l_errCode);
        if (l_errCode)
        {
            m_logger->logMessage(
        ...
        vpdSpecificUtility::setCollectionStatusProperty(
            l_fruPath, types::CollectionStatus::COMPLETED, m_parsedJson,
            l_errCode);
        if (l_errCode)
        {
            m_logger->logMessage(
