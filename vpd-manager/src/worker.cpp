...
void Worker::deleteFruVpd(const std::string& i_dbusObjPath)
{
    ...
    const std::string& l_fruPath = jsonUtility::getFruPathFromJson(
        l_chassisBasedJson, i_dbusObjPath, l_errCode);
    ...
    try
    {
        ...
        vpdSpecificUtility::resetObjTreeVpd(l_fruPath, l_chassisBasedJson,
                                            l_errCode);
    ...
    catch (const std::exception& l_ex)
    {
                                          ...
                                          l_errCode))
        {
            if (!jsonUtility::executePostFailAction(
                    l_chassisBasedJson, l_fruPath, "deletion", l_errCode))
            {
    ...
    const sdbusplus::message::object_path& i_dbusObjPath)
{
    ...
    try
    {
        ...
        l_fruPath = jsonUtility::getFruPathFromJson(l_chassisBasedJson,
        ...
        if (dbusUtility::isHostRunning())
        {
            ...
            bool isFruReplaceableAtRuntime =
                jsonUtility::isFruReplaceableAtRuntime(l_chassisBasedJson,
                                                       l_fruPath, l_errCode);
        ...
        else if (dbusUtility::isBMCReady())
        {
            ...
            bool isFruReplaceableAtStandby =
                jsonUtility::isFruReplaceableAtStandby(l_chassisBasedJson,
                                                       l_fruPath, l_errCode);
        ...
        vpdSpecificUtility::setCollectionStatusProperty(
            l_fruPath, types::VpdCollectionStatus::InProgress,
        ...
        vpdSpecificUtility::setCollectionStatusProperty(
            l_fruPath, types::VpdCollectionStatus::Completed,
            l_chassisBasedJson, l_errCode);
        if (l_errCode)
        {
            m_logger->logMessage(
