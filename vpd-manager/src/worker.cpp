    ...
    m_configJsonPath(pathToConfigJson), m_semaphore(i_maxThreadCount)
{
    ...
    if (!m_configJsonPath.empty())
    {
        ...
        try
        {
            ...
            m_parsedJson =
                jsonUtility::getParsedJson(m_configJsonPath, io_error_code);
...
void Worker::setDeviceTreeAndJson()
{
    ...
    uint16_t io_error_code = 0;
    m_parsedJson = jsonUtility::getParsedJson(systemJson, io_error_code);
    ...
    const std::string& i_vpdFilePath)
{
    ...
    try
    {
        ...
        l_inventoryPath = jsonUtility::getInventoryObjPathFromJson(
            m_parsedJson, i_vpdFilePath, io_error_code);
