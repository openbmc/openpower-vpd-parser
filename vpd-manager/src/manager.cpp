                           ...
                           const types::WriteVpdParams i_paramsToWriteData)
{
    ...
    try
    {
        ...
        if (!l_errCode)
        {
            commonUtility::getEffectiveFruPath(l_vpdMode, l_effectiveFruPath,
                                               l_errCode);
        ...
        std::cout << "DBG: Paths after getting effective FRU path" << std::endl;
        std::cout << "DBG: Effective FRU path : " << l_effectiveFruPath << std::endl;
        std::cout << "DBG: FRU path : " << l_fruPath << std::endl;
    ...
    const types::WriteVpdParams i_paramsToWriteData) noexcept
{
    try
    {
        ...
        {
            Logger::getLoggerInstance()->logMessage(
                "Failed to get effective FRU path for system VPD : " +
                commonUtility::getErrCodeMsg(l_errCode));
        }
