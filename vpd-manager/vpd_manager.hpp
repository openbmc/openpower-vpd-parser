...
/** @class Manager
 *  @brief OpenBMC Manager implementation.
 *  This class implemets interface provided by VPD manager.
 *
...
class Manager : public ServerObject<ManagerIface>
{
  public:
     ...
     */
    void writeKeyword(const sdbusplus::message::object_path path, const std::string recordName,
