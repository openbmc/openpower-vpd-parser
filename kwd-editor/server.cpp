...
int VPDKeywordEditor::_callback_WriteKeyword(
...
static const auto _param_WriteKeyword =
        utility::tuple_to_array(message::types::type_id<
                std::string, std::string, std::string, std::vector<uint8_t>>());
...
const vtable::vtable_t VPDKeywordEditor::_vtable[] = {
    ...
    vtable::method("WriteKeyword",
                   details::VPDKeywordEditor::_param_WriteKeyword
                        .data(),
                   details::VPDKeywordEditor::_return_WriteKeyword
                        .data(),
