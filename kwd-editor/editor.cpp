...
RecordOffset Editor::checkPTForRecord(Binary::const_iterator& iterator,
                                      std::size_t ptLength, std::string recName)
{
...
void Editor::updateData(Binary kwdData, std::size_t dataLength,
                        Binary::iterator iterator)
{
    std::size_t length = kwdData.size();
    std::size_t lengthToUpdate = length <= dataLength ? length : dataLength;
...
void Editor::checkRecordForKwd(RecordOffset recOffset, std::string kwdName,
                               Binary kwdData)
{
    // Jump to record name
...
Binary Editor::updateKeyword(Binary::const_iterator& iterator,
                             std::size_t ptLength, std::string recName,
                             std::string kwdName, Binary kwdData)
{
