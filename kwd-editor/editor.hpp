...
class Editor
{
  public:
     ...
     *
     *  @returns[out] Modified VPD file
     **/
    Binary updateKeyword(Binary::const_iterator& iterator, std::size_t ptLength,
                         std::string recName, std::string kwdName,
                         Binary kwdData);
  ...
  private:
     ...
     *
     **/
    void checkRecordForKwd(RecordOffset offset, std::string kwdName,
                           Binary kwdData);
     ...
     *
     **/
    void updateData(Binary kwdData, std::size_t dataLength,
