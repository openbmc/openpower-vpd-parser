 ...
 * */
bool getKwValue(Parsed& backupVpdMap, const std::string& backupVpdRecName,
        ...
        if (it != vpdMap.end())
        {
            ...
            for (const auto& keywordInfo : kwdListForRecord)
            {
                ...
                if (iterator != kwdValMap.end())
                {
                    ...
                    {
                        if (!getKwValue(backupVpdMap, backupVpdRecName,
                                        backupVpdKwName, backupVpdInvPath,
                                        systemVpdBackupPath, backupValue))
                        {
                            continue;
                        }
                    }
