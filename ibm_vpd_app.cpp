                      ...
                      nlohmann::json& js, bool isBackupOnCache = true)
{
    ...
    if (!isBackupOnCache)
    {
        ...
        {
            std::cerr << "Back up VPD map is empty" << std::endl;
            return;
        }
    }
        ...
        if (it != vpdMap.end())
        {
            ...
            for (const auto& keywordInfo : kwdListForRecord)
            {
                ...
                if (iterator != kwdValMap.end())
                {
                    ...
                    // If the 'isBackupOnCache' is false, we need
                        ...
                        if (backupValue.empty())
                        {
                            ...
                            else
                            {
                                errorMsg = backupVpdKwName +
                                           " Keyword not found or empty in "
                                           "the backup EEPROM file ";
                            }
                    ...
                    if (backupDataInBinary != defaultValue)
                    {
                        if (kwdDataInBinary != defaultValue)
                        {
                            ...
                            {
                                std::cout
                                    << "Both the data are same non default"
                                    << std::endl;
                                continue;
                            }
                        }
    ...
    if (!isBackupOnCache)
    {
        ...
        populateDbus(backupVpdMap, js, systemVpdBackupPath);
    }
}
