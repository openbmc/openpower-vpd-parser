                ...
                if (iterator != kwdValMap.end())
                {
                        ...
                        string::npos)
                    {
                            ...
                            string::npos)
                        {
                            ...
                            {
                                string errMsg = "VPD data mismatch on backup "
                             ...
                             string::npos)
                    {
                        ...
                        string errMsg = "Found manufacturing default value on "
                                        "both backup and hardware for record: ";
                        errMsg += (*it).first;
                        errMsg += " and keyword: ";
                        errMsg += keyword;
                        ...
                        createPEL(additionalData, PelSeverity::ERROR,
                                  errIntfForSystemVPDDefault, nullptr);
                        continue;
                    }
                }
            }
