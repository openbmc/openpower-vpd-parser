...
void setDevTreeEnv(const string& systemType)
{
	...
	std::string err = "This System type not found/supported in dtb table " + systemType;

        // map to hold additional data in case of logging pel
        PelAdditionalData additionalData{};
        additionalData.emplace("DESCRIPTION", err);
        createPEL(additionalData, PelSeverity::WARNING, errIntfForSystemTypeNotSupported);
    }
