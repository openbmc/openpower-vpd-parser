...
class isdimmVpdParser : public ParserInterface
{
  ...
  private:
     ...
     */
    auto getDDR4FruNumber(std::string& partNumber);
     ...
     */
    auto getDDR4CCIN(std::string& partNumber);
     ...
     * @return allocated FRU number.
     */
    auto getDDR5FruNumber(std::string& partNumber);
     ...
     * @return allocated CCIN.
     */
    auto getDDR5CCIN(std::string& partNumber);
