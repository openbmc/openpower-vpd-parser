...
static constexpr auto SPD_JEDEC_DDR4_DRAM_MANUFACTURER_ID_LENGTH = 2;
...
static constexpr auto SPD_JEDEC_DDR5_DRAM_MANUFACTURER_ID_LENGTH = 2;
...
{
    Binary mfgId(SPD_JEDEC_DDR4_DRAM_MANUFACTURER_ID_LENGTH);

    if (memVpd.size() < (SPD_JEDEC_DDR4_DRAM_MANUFACTURER_ID_OFFSET +
                         SPD_JEDEC_DDR4_DRAM_MANUFACTURER_ID_LENGTH))
    {
        std::cout
    ...
    std::copy_n((memVpd.cbegin() + SPD_JEDEC_DDR4_DRAM_MANUFACTURER_ID_OFFSET),
                SPD_JEDEC_DDR4_DRAM_MANUFACTURER_ID_LENGTH, mfgId.begin());
...
{
    Binary mfgId(SPD_JEDEC_DDR5_DRAM_MANUFACTURER_ID_LENGTH);

    if (memVpd.size() < (SPD_JEDEC_DDR5_DRAM_MANUFACTURER_ID_OFFSET +
                         SPD_JEDEC_DDR5_DRAM_MANUFACTURER_ID_LENGTH))
    {
        std::cout
            << "VPD length is less than the offset of Manufacturer ID. Can't fetch it"
            << std::endl;
    ...
    std::copy_n((memVpd.cbegin() + SPD_JEDEC_DDR5_DRAM_MANUFACTURER_ID_OFFSET),
                SPD_JEDEC_DDR5_DRAM_MANUFACTURER_ID_LENGTH, mfgId.begin());
