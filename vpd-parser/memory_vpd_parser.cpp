...
auto memoryVpdParser::getDimmSize(Binary::const_iterator iterator)
{
    ...
    if (sdramType == SdRamType::EN_DDR4)
    {
        ...
        size_t sdramCap = 1, priBusWid = 1, sdramWid = 1,
               logicalRanksPerDimm = 1;
        Byte dieCount = 1;
    ...
    else if (sdramType == SdRamType::EN_DDR5)
    {
        ...
        priBusWidPerChanl = (priBusWidPerChanl << tmp) *
                            JEDEC_PRI_BUS_WIDTH_PER_CHNL_MULTIPLIER;
        ...
        else
        {
            ...
            priSdramIoWid =
                (priSdramIoWid << tmp) * JEDEC_SDRAM_WIDTH_MULTIPLIER;
            ...
            getNumOfEvenAndOddNumbrsInGivenNum(noOfPkgRankPerChnl,
                                               evenRanksCount, oddRanksCount);
