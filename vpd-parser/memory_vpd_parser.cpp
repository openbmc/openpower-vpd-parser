 ...
 * @param sdramIoWid[out] - The SDRAM I/O Width
...
static auto getSdramParamsFromSPDData(Binary::const_iterator& iterator,
                                      size_t& sdramIoWid, uint8_t& diePerPkg,
                                      uint8_t& dramDnstyPerDie)
{
    size_t retVal = 0;
...
auto memoryVpdParser::getDDR5DimmSize(Binary::const_iterator& iterator)
{
    ...
    uint8_t noOfChanlPerDimm = 0, priBusWidPerChanl = 1;
    ...
    tmp = tmp >> JEDEC_NUM_OF_CHNLS_PER_DIMM_COUNT_RIGHT_SHIFT;
    ...
    else
    {
        ...
        auto retVal = getSdramParamsFromSPDData(
        ...
        retVal = getSdramParamsFromSPDData(
