...
static constexpr auto SPD_JEDEC_DDR5_MEM_BYTE_2 = 2;
static constexpr auto SPD_JEDEC_DDR5_MEM_BYTE_4 = 4;
static constexpr auto SPD_JEDEC_DDR5_MEM_BYTE_6 = 6;
static constexpr auto SPD_JEDEC_DDR5_MEM_BYTE_8 = 8;
static constexpr auto SPD_JEDEC_DDR5_MEM_BYTE_10 = 10;
static constexpr auto SPD_JEDEC_DDR5_MEM_BYTE_234 = 234;
static constexpr auto SPD_JEDEC_DDR5_MEM_BYTE_235 = 235;
...
static constexpr auto SPD_JEDEC_DDR5_NUM_OF_PKG_RANKS_PER_CHNL_RESERVED_BITS =
    7;
                                      ...
                                      size_t& sdramDnstyPerDie)
{
    ...
    tmp = iterator[SPD_JEDEC_DDR5_MEM_BYTE_6] &
          SPD_JEDEC_DDR5_SDRAM_IO_WIDTH_MASK;
    ...
    tmp = iterator[SPD_JEDEC_DDR5_MEM_BYTE_4] & SPD_JEDEC_DDR5_DIE_PER_PKG_MASK;
    ...
    tmp = iterator[SPD_JEDEC_DDR5_MEM_BYTE_4] &
...
auto memoryVpdParser::getDDR5DimmSize(Binary::const_iterator& iterator)
{
    ...
    tmp = iterator[SPD_JEDEC_DDR5_MEM_BYTE_235] &
    ...
    else
    {
        ...
        tmp = iterator[SPD_JEDEC_DDR5_MEM_BYTE_10] &
              SPD_JEDEC_DDR5_SDRAM_IO_WIDTH_MASK;
        tmp = tmp >> SPD_JEDEC_DDR5_SDRAM_IO_WIDTH_COUNT_RIGHT_SHIFT;
        if (tmp > SPD_JEDEC_DDR5_SDRAM_IO_WIDTH_RESERVED_BITS)
        {
        ...
        // Calculate Die per Package
        tmp = iterator[SPD_JEDEC_DDR5_MEM_BYTE_8] &
              SPD_JEDEC_DDR5_DIE_PER_PKG_MASK;
        tmp = tmp >> SPD_JEDEC_DDR5_SDRAM_DIE_PER_PKG_COUNT_RIGHT_SHIFT;
...
{
    size_t dimmSize = 0;
    size_t sdramType = iterator[SPD_JEDEC_DDR5_MEM_BYTE_2];
