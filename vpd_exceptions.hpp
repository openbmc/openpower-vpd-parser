 ...
 * @param[in] -
 */
explicit EepromException(const std::string& msg, const std::string& eepromFile, const int error, const std::string& strError) : VPDException(msg), eepromPath(eepromFile), errorCode(error), errorDesc(strError)
{
}
