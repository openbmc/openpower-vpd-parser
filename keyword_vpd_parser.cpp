...
KeywordVpdMap KeywordVpdParser::parseKwVpd()
{
    ...
    validateVendorDefinedLargeResourceType();
...
void KeywordVpdParser::validateVendorDefinedLargeResourceType()
{
    ...
    {
        throw std::runtime_error("Invalid Vendor Defined Large resource type");
    }
}
