...
using IpzKeywordMap = Parsed_rawData::mapped_type;

using maps = std::tuple<KeywordMap, IpzKeywordMap>;
...
class Impl
{
  public:
     ...
     *
     *  @returns collection of openpower::vpd::Store and Store_rawData object
     */
    Stores run();
  ...
  private:
     ...
     */
    internal::maps readKeywords(Binary::const_iterator iterator);
