...
TEST_F(KeywordVpdParserTest, GoodTestCase)
{
    ...
    KeywordVpdMap map1 {
        ...
        pair<std::string, Binary> {"PN", {0x30, 0x31, 0x4b, 0x55, 0x37, 0x32, 0x34}},
        pair<std::string, Binary> {"FN", {0x20, 0x30, 0x31, 0x4b, 0x55, 0x37, 0x32, 0x34}},
    ...
    map1 = {
	    pair<std::string, Binary> {"B2",
            ...
            pair<std::string, Binary> {"FN", {0x30, 0x32, 0x44, 0x45, 0x33, 0x36, 0x35}},
            pair<std::string, Binary> {"PN", {0x30, 0x32, 0x44, 0x45, 0x33, 0x36, 0x36}},
            pair<std::string, Binary> {"RV", {0xa1}},
            pair<std::string, Binary> {"SI", {0x31, 0x30, 0x31, 0x34, 0x30, 0x36, 0x37, 0x34}},
            pair<std::string, Binary> {"SN",
             {0x59, 0x4c, 0x35, 0x30, 0x48, 0x54, 0x39, 0x36, 0x4a, 0x30, 0x30,
              0x38}},
            pair<std::string, Binary> {"Z4", {0x30}},
            pair<std::string, Binary> {"Z5", {0x30}},
            pair<std::string, Binary> {"Z6", {0x41, 0x31, 0x38, 0x30, 0x30, 0x32, 0x30, 0x30}}};
