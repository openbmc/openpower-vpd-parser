...
#ifdef IPZ_PARSER
        // This is under this flag as Json header os required for api
        // storeOffset but it is not available in witherspoon currently so build
        // fails for openpower there.
        try
        {
