...
class VpdTool
{
  private:
     ...
     */
    auto makeDBusCall(const std::string& objectName, const std::string& interface,
                      const std::string& kw);
     ...
     * are placed
     */
    void addFruTypeAndLocation(json exIntf, const std::string& object, json& kwVal);
     ...
     *         extraInterface.
     */
    void getExtraInterfaceProperties(std::string invPath, std::string extraInterface,
