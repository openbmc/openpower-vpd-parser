...
static const inventory::SystemVPDList svpdKwdMap{
    {"VSYS",
     {inventory::SystemVPDKwData("BR", Binary(2, 0x20), true, true),
      inventory::SystemVPDKwData("TM", Binary(8, 0x20), true, true),
      inventory::SystemVPDKwData("SE", Binary(7, 0x20), true, true),
      inventory::SystemVPDKwData("SU", Binary(6, 0x20), true, true),
      inventory::SystemVPDKwData("RB", Binary(4, 0x20), true, true),
      inventory::SystemVPDKwData("WN", Binary(12, 0x20), true, true),
      inventory::SystemVPDKwData("RG", Binary(4, 0x20), true, true),
      inventory::SystemVPDKwData("FV", Binary(32, 0x20), false, true)}},
    {"VCEN",
     {inventory::SystemVPDKwData("FC", Binary(), true, false),
      inventory::SystemVPDKwData("SE", Binary(7, 0x20), true, true)}},
    {"LXR0", {inventory::SystemVPDKwData("LX", Binary(), true, false)}},
    {"UTIL", {inventory::SystemVPDKwData("D0", Binary(1, 0x00), true, true)}}};
