 ...
 * @param[out] vpdVector - vector of VPD data.
 * @return Parsed VPD data map.
 */
std::variant<inventory::KeywordVpdMap, Store>
    getVPDInMap(const std::string& vpdPath, nlohmann::json& js,
                const std::string& invPath, Binary& vpdVector);
} // namespace vpd
} // namespace openpower