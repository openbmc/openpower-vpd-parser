...
std::variant<openpower::vpd::inventory::KeywordVpdMap, openpower::vpd::Store> parseVpdFile(const std::string& vpdFilePath,
                                                const std::string& invPath,
                                                const nlohmann::json& jsonFile,
                                                openpower::vpd::parser::interface::ParserInterface*& parserObj)
{
    ...
    parserObj = openpower::vpd::parser::factory::ParserFactory::getParser(vpdVector, (pimPath + invPath),
                                         vpdFilePath, vpdStartOffset);

    auto parseResult = parserObj->parse();
