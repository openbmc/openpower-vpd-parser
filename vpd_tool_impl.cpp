...
json VpdTool::interfaceDecider(json& itemEEPROM)
{
    ...
    if (objFound)
    {
        ...
        {
// Properties under Decorator.Asset interface are derived from VINI keywords. Displaying VINI keywords and skipping Decorator.Asset interface's properties will avoid duplicate entries in vpd-tool output.
