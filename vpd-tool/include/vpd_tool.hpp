...
class VpdTool
{
  private:
    ...
    /**
     * @brief API to get value of BIOS attribute for keyword.
     *
     ...
     * attribute value from BIOS Config Manager, and returns the appropriate VPD
     * value.
     *
     ...
     */
    types::BinaryVector getBiosAttributeValueForKeyword(
