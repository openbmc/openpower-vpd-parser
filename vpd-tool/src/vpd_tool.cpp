...
{
    int l_rc = error_codes::ErrorCode::STANDARD_EXCEPTION;
    try
    {
            ...
            i_keywordValue.empty())
        {
            ...
            return error_codes::ErrorCode::INVALID_INPUT_PARAMETER;
        }
        ...
        if (i_onHardware)
        {
            ...
            if (l_rc <= 0)
            {
                return error_codes::ErrorCode::DBUS_CALL_FAILED;
            }
        }
        else
        {
    ...
    catch (const std::exception& l_ex)
    {
        ...
        return error_codes::ErrorCode::STANDARD_EXCEPTION;
    }
}
