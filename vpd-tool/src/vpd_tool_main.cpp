 ...
 * @param[in] i_recordName - Record to be updated (optional for Keyword VPD format).
 ...
 * @param[in] i_recordOption - Option flag indicating if record was provided.
 * @param[in] i_vpdPath - DBus object path or EEPROM path.
 * @param[in] i_recordName - Record to be read (optional for Keyword VPD format).
