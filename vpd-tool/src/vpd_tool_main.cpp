                 ...
                 const std::string& i_keywordValue)
{
    ...
    vpd::VpdTool l_vpdToolObj;
    return l_vpdToolObj.writeKeyword(
        i_vpdPath,
        (!i_recordOption->empty()) ? std::make_optional(i_recordName)
                                   : std::nullopt,
        i_keywordName, i_keywordValue, !i_hardwareFlag->empty());
}
                ...
                const std::string& i_keywordName, const std::string& i_filePath)
{
    ...
    vpd::VpdTool l_vpdToolObj;
    return l_vpdToolObj.readKeyword(
        i_vpdPath,
        (!i_recordOption->empty()) ? std::make_optional(i_recordName)
                                   : std::nullopt,
        i_keywordName, l_isHardwareOperation, i_filePath);
}
...
void updateFooter(CLI::App& i_app)
{
    i_app.footer(
        ...
        "    Keyword Format (Without Record option):\n"
        "        From hardware to console: "
