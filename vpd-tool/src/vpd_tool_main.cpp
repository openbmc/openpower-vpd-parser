...
void updateFooter(CLI::App& i_app)
{
    i_app.footer(
        ...
        "Enter Split mode:\n"
        "   Configure the system to enter split mode. If path is provided, copies path to file mode loaction. "
        "   vpd-tool --enterSplitMode --file <File Path>\n"
        "   Else, considers the file is available at file mode location.\n"
