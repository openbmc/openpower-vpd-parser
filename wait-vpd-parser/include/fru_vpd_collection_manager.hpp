...
class FruVpdCollectionManager final
{
  ...
  private:
    ...
    // flag which indicates FRU VPD collection has been successfully triggered
    bool m_collectAllFruVpdTriggered{false};

    // flag which indicates if collection is done
