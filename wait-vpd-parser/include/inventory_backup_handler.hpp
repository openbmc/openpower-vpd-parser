...
class InventoryBackupHandler
{
  ...
  private:
     ...
     */
    inline bool checkInventoryBackupPath(uint16_t& o_errCode) const;
     ...
     * @throw std::runtime_error
     */
    inline bool restoreInventoryBackupData(uint16_t& o_errCode) const;
     ...
     * @throw std::runtime_error
     */
    inline bool clearInventoryBackupData(uint16_t& o_errCode) const;
     ...
     * @throw std::runtime_error
     */
    inline bool restartInventoryManagerService(uint16_t& o_errCode) const;
