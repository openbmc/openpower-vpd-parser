...
class InventoryBackupHandler
{
  public:
    ...
    /**
     * @brief API to get inventory manager service name
     *
     * @return name of the inventory manager service
     */
    const std::string& getInventoryManagerServiceName() const noexcept
    {
        return m_inventoryManagerServiceName;
    }
